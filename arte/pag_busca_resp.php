...
$stmt = $mysqli->prepare("SELECT COUNT(`id_pedido`) FROM `responsaveis` WHERE `id_user` = ?"); 
...
<link rel="stylesheet" href="/megalabel/style.css">
    ...
    hr.open("POST", "busca_resp.php", true);
...
<center>
  ...
  <table align="center" width="986px" height="62px" border="0" cellpadding="0" cellspacing="0">
	...
	<div class="boxfila"><div class="headerfila">Pedidos que fui Responsavel.</div>	
