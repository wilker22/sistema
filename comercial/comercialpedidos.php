<?php //comercialpedidos.php com pagination
...
$stmt = $mysqli->prepare("SELECT COUNT(`id_pedido`) FROM `pedido_megalabel` WHERE `id_representante` = ?"); 
...
function request_page(pn){
    ...
    hr.onreadystatechange = function() {
	    ...
	    html_output +=  "<div class='pedidofilacomerc'><ul> <li>Ref. Trabalho: "+itemArray[5]+" </li> <br /><li>Status: "+itemArray[4]+" - Pedido: "+itemArray[0]+"  - Data NF: "+itemArray[7]+" </li><br /> <li> Data: "+itemArray[1]+"  -Empresa:  "+itemArray[2]+" - CNPJ: "+itemArray[3]+" </li> </ul><div class='btpedido1'><form action='comercialverpedido.php' method='post'><input type='hidden' name='id_pedido' value='"+itemArray[0]+"'/><input type='submit'  name='verpedido' value='Visualizar pedido'/></form></div></div>";
    ...
    if(last != 1){
		...
		paginationCtrls += ' &nbsp; &nbsp; <b>Pagina '+pn+' de '+last+'</b> &nbsp; &nbsp; ';
    	if (pn != last) {
        	paginationCtrls += '<button onclick="request_page('+(pn+1)+')">&gt;</button>';
    	}
    }
...
<center>
  ...
  <table align="center" width="986px" height="62px" border="0" cellpadding="0" cellspacing="0">
	...
	<div class="boxfila"><div class="headerfila">Pedidos realizados pelo representante: $nome_representante <div id="pagination_controls"></div></div>	
