...
echo '<META HTTP-EQUIV=Refresh CONTENT="0; URL='.$url.'">';
	...
	$stmt = $mysqli->prepare("SELECT COUNT(`id_pedido`) FROM `fluxo` WHERE `id_user` = ?"); 
...
function request_page(pn){
	...
	results_box.innerHTML = "<div class='pedidofilacomerc'><ul><li><img src='/megalabel/img/teste.gif' alt='Carregando' width='110' height='110'></li></ul></div>";
	var hr = new XMLHttpRequest();
    hr.open("POST", "pagination_parser_producao.php", true);
	...
	html_output +=  "<div class='pedidofilacomerc'><ul><li>Pedido: "+itemArray[0]+"</li></ul><div class='btpedido1'><form action='producao.php' method='post'><input type='hidden' name='id_pedido' value='"+itemArray[0]+"'/><input type='submit'  name='envia_revisao' value='Finalizar'/><input type='submit'  name='devolve_arte' value='Devolver Para Arte'/></form></div></div>";
...
<center>
  ...
  <table align="center" width="986px" height="62px" border="0" cellpadding="0" cellspacing="0">
	...
	<div class="boxfila"><div class="headerfila">Fila de pedidos Producao<div id="pagination_controls"></div></div>	
