...
if (isset($_POST['resp']) ){
	...
	$url = 'http://www.rixd.com.br/megalabel/faturamento/pag_busca_resp.php';
...
if(busca2 =="resp"){
					...
					document.getElementById('busca_id').style.display='none'; 
			document.getElementById('busca_respons').style.display='block';         
		}
...
<br /> 
	      ...
	      <option value="resp">Pedidos que fui resp.</option>
	      ...
	      <div id="busca_respons" style="display:none">	 
	      <form action="busca.php" method="post">     
	      <input type="submit"  id="resp" name="resp" value="Visualizar" />	      
	      </form>
	      </div>
_END;
