...
$sql = $mysqli->prepare("UPDATE fluxo
SET `id_area`= 2, id_user= ?
WHERE id_pedido = ? ");
$sql->bind_param('ss', $id_user, $id_pedido);
	$sql->execute();
	$sql->store_result();
...
<center>
  ...
  <table align="center" width="986px" height="62px" border="0" cellpadding="0" cellspacing="0">
	...
	<div class="boxfila"><div class="headerfila">Fila de pedidos PCP</div>	
<br /> 
_END;
